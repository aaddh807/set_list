                ...
                if set_length < (sample_number * 2):
                    pass
                        ...
                        if count <= limit1:  #only read the sets before limit1
                            ...
                            with open(f"gemini_1.5_flash_output_all_{sample_number}sample_random_{limit1}_{limit2}_diff_sample.txt","a") as a, open(f"gemini_1.5_flash_output_generated_list_all_{sample_number}sample_{limit1}_{limit2}_diff_sample.csv","a") as a3,open(f"gemini_1.5_flash_output_stat_all_{sample_number}sample_csv_format_{limit1}_{limit2}_diff_sample.csv","a") as a4,open(f"gemini_desired_output_{limit1}_{limit2}_diff_sample.csv","a") as a5,open(f"erro_set_missing_{limit1}_{limit2}.csv","a") as a6:
                                        a.write(prompt)
                                        a.write(f"\nmodel output:\n")

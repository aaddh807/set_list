            ...
            if set_length < (sample_number*2):
                ...
                pass
                    ...
                    with model.chat_session():
                        with open(f"llama3_8b_instruct_output_all_{sample_number}sample_random_first_3_sample.txt","a") as a,open(f"llama3_8b_instruct_output_generated_list_all_{sample_number}sample_random_first_3_sample.csv","a") as a3, open(f"llama3_8b_instruct_output_stat_all_{sample_number}sample_csv_format_random_first_3_sample.csv","a") as a4, open(f"llama3_8b_instruct_output_desire_output_first_3_sample.csv","a") as a5:
                            a.write(prompt)
                            a.write(f"\nmodel output:\n")
                            ...
                            for generated_element in generate_list:
                                element_final = ''
                                if generated_element in element_list[0:3]:
